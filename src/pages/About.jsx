          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-black via-black to-green-950 p-7 md:p-10">
            <div className="grid gap-8 md:grid-cols-12 items-center">
              <div className="md:col-span-7">
                ...
                <p className="mt-3 text-sm md:text-base text-gray-300 leading-relaxed">
                  RKR BrandTech Solutions is driven by a tech-first mindset, combining IT
                  support experience with cybersecurity-focused knowledge. Our goal is to
                  deliver real value: stable systems, reduced risk, and a professional business presence.
                </p>
